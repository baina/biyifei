	...
	if pcontent then
		...
		if wxtable.MsgType ~= "text" then
			if wxtable.MsgType == "event" and wxtable.Event == "subscribe" then
				mt = "告诉你一个秘密，刚刚关注的是微信小比，你可以把她当成出行小秘书，在微信上能帮你比较各大网站的机票价格！\n\n回复序号查询航班比价：\n\n[1]单程比价\n[2]往返比价\n[3]热点线路";
				ngx.print(([=[<xml>
